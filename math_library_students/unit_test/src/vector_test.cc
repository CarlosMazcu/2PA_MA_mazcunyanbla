...
namespace UnitTest {
  ...
  void Vec3Test() {
    ...
    bool worked = false;
    // 0 differences
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f;
    worked = (test == another_test);
    Assert::AreEqual(true, worked, "Operator== Failed", __FILE__, __LINE__);
    // X is different
    test.x = 42.0f; test.y = 1.5f; test.z = 2.5f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed X", __FILE__, __LINE__);
    // Y is different
    test.x = 0.5f; test.y = 42.0f; test.z = 2.5f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed Y", __FILE__, __LINE__);
    // Z is different
    test.x = 0.5f; test.y = 1.5f; test.z = 42.0f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed Z", __FILE__, __LINE__);

    //------------------//
    // -- Operator!= -- //
    //-----------------//
    // All are different
    test.x = 42.0f; test.y = 42.0f; test.z = 42.0f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator!= Failed", __FILE__, __LINE__);
    // 0 differences
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f;
    ...
    test.x = 42.0f; test.y = 1.5f; test.z = 2.5f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator== Failed X", __FILE__, __LINE__);
    // Y is different
    test.x = 0.5f; test.y = 42.0f; test.z = 2.5f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator== Failed Y", __FILE__, __LINE__);
    // Z is different
    test.x = 0.5f; test.y = 1.5f; test.z = 42.0f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator== Failed Z", __FILE__, __LINE__);
  ...
  void Vec4Test() {
    ...
    //-----------------//
    bool worked = false;
    Vec4 another_test = Vec4(0.5f, 1.5f, 2.5f, 3.5f);
    // 0 differences
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f; test.w = 3.5f;
    worked = (test == another_test);
    Assert::AreEqual(true, worked, "Operator== Failed", __FILE__, __LINE__);
    // X is different
    test.x = 42.0f; test.y = 1.5f; test.z = 2.5f; test.w = 3.5f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed X", __FILE__, __LINE__);
    // Y is different
    test.x = 0.5f; test.y = 42.0f; test.z = 2.5f; test.w = 3.5f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed Y", __FILE__, __LINE__);
    // Z is different
    test.x = 0.5f; test.y = 1.5f; test.z = 42.0f; test.w = 3.5f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed Z", __FILE__, __LINE__);
    // W is different
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f; test.w = 42.0f;
    worked = (test == another_test);
    Assert::AreEqual(false, worked, "Operator== Failed W", __FILE__, __LINE__);

    //------------------//
    // -- Operator!= -- //
    //-----------------//
    // All are different
    test.x = 42.0f; test.y = 42.0f; test.z = 42.0f; test.w = 42.0f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator!= Failed", __FILE__, __LINE__);
    // 0 differences
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f; test.w = 3.5f;
    ...
    test.x = 0.5f; test.y = 1.5f; test.z = 2.5f; test.w = 42.0f;
    worked = (test != another_test);
    Assert::AreEqual(true, worked, "Operator== Failed W", __FILE__, __LINE__);
