 ...
 * @brief Source code of app_window.h
 * @version 2.0
 * @date 2023-11-28
 * 
...
{
  GameManager &GM = GameManager::Instance();
  if(esat::IsSpecialKeyPressed(esat::kSpecialKey_Right) && GM.incr_speed_ <= 2.0f)
  {
    printf("\n%f", GM.incr_speed_);
    GM.incr_speed_+=0.0025f;
  }
  if(esat::IsSpecialKeyPressed(esat::kSpecialKey_Left) && GM.incr_speed_ >= 0.0f)
  {
    printf("\n%f", GM.incr_speed_);
    GM.incr_speed_-=0.0025f;
  }
