...
void initAnimationConfigFlygon()
{
  ...
  GM.all_config_.ac_flygon_ = {
            1, 0, 0, 
            {-(float)GM.all_sprites.flygon.width(), 100.0f}, {-(float)GM.all_sprites.flygon.width(), 500.0f}, 5.5f, 
            0.0f, 0.0f, 0.0f, 
...
void updateAnimationFlygon()
{
  ...
  if (GM.all_sprites.flygon.animation_->config_.is_moving == 0)
  {
    ...
    case 1:
      GM.all_config_.ac_flygon_ = {
          1, 0, 1, 
          {-(float)GM.all_sprites.flygon.width() / 1.5f, 500.0f / 1.5f}, {GM.windowSize.x * 2.0f /3.5f, 150.0f / 3.5f}, 2.5f, 
          0.0f, 0.0f, 0.0f, 
